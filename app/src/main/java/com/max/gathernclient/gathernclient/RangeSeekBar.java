...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    public static final int HEIGHT_IN_DP = 35;
     ...
     */
    public static final int DEFAULT_COLOR =Color.parseColor("#89719D");
            //sh Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    /**
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.mydarkgray));
    ...
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas, boolean areSelectedValuesDefault) {
        Bitmap buttonToDraw = getBitmapFromDrawable(R.drawable.seekbar_thumb);
//       if (areSelectedValuesDefault) {
//            buttonToDraw = thumbPressedImage;
//        } else {
//            buttonToDraw = pressed ? thumbPressedImage : thumbPressedImage;
//        }
